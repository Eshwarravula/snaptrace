...
export default function LoginPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      if (mode === "signup") {
        ...
        setMessage("Signup created. Check email if confirmation is enabled, then sign in.");
      } else {
  ...
  async function googleLogin() {
    setMessage("");
    if (!supabase) {
      setMessage("Google login needs Supabase env vars in Vercel. For now, use local mode or add the public anon key.");
      return;
    }
